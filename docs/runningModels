...
- these templates use an audio_path for where to find audio files, output_path for where to store the results and a path to the ocnda environment to activate, change them accordingly in the script.
...
And that is it, chack in your output_path that it contains your rttm annotations and you are ready to procede to [importation](#importing-the-new-annotations-to-the-dataset).
